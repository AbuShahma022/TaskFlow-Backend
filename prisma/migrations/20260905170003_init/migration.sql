...
-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('PROJECT_CREATED', 'PROJECT_UPDATED', 'PROJECT_ARCHIVED', 'MEMBER_INVITED', 'MEMBER_ADDED', 'MEMBER_REMOVED', 'TASK_CREATED', 'TASK_UPDATED', 'TASK_ASSIGNED', 'TASK_STATUS_CHANGED', 'TASK_COMPLETED', 'SPRINT_STARTED', 'SPRINT_COMPLETED', 'SUBSCRIPTION_CHANGED', 'PAYMENT_COMPLETED');

-- CreateEnum
CREATE TYPE "ActivityEntityType" AS ENUM ('ORGANIZATION', 'MEMBER', 'TEAM', 'PROJECT', 'SPRINT', 'TASK', 'COMMENT', 'SUBSCRIPTION', 'PAYMENT');
...
-- CreateIndex
CREATE INDEX "organization_invitations_invitedUserId_idx" ON "organization_invitations"("invitedUserId");
...
-- AddForeignKey
ALTER TABLE "organization_invitations" ADD CONSTRAINT "organization_invitations_invitedUserId_fkey" FOREIGN KEY ("invitedUserId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
